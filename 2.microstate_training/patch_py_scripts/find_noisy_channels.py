...
class NoisyChannels:
    ...
    def find_all_bads(self, ransac=True, channel_wise=False, max_chunk_size=None, kwargs={}):
        ...
        self.find_bad_by_deviation(kwargs.get('deviation_threshold', 5.0))
        self.find_bad_by_hfnoise(kwargs.get('HF_zscore_threshold', 5.0))
        
        self.find_bad_by_correlation(kwargs.get('correlation_secs', 1.0), 
                                     kwargs.get('correlation_threshold', 0.4), 
                                     kwargs.get('frac_bad', 0.01))
