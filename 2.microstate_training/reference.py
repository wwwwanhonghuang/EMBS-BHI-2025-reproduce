...
class Reference:
    ...
    def perform_reference(self, max_iterations=4, args = {}):
        ...
        self.robust_reference(max_iterations, args)
        ...
        noisy_detector.find_all_bads(self.ransac_settings['ransac'],
                                     self.ransac_settings['channel_wise'],
                                     self.ransac_settings['max_chunk_size'],
                                     args)
        ...
        noisy_detector.find_all_bads(self.ransac_settings['ransac'],
                                     self.ransac_settings['channel_wise'],
                                     self.ransac_settings['max_chunk_size'], args)
    ...
    def robust_reference(self, max_iterations=4, args={}):
